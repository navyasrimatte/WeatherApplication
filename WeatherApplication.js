...
async function getWeatherData() {
    ...
    try {
        ...
        if (weatherMain.includes("cloud")) {
            weatherImage.src = "WeatherApplication/assets/2682832_cloud_day_forecast_sun_weather_icon.png";
        } else if (weatherMain.includes("rain")) {
            weatherImage.src = "WeatherApplication/assets/5729387_cloudy_lightning_weather_cloud_forecast_icon.png";
        } else if (weatherMain.includes("clear")) {
            weatherImage.src = "WeatherApplication/assets/2682848_day_forecast_sun_sunny_weather_icon.png";
        } else if (weatherMain.includes("haze") || weatherMain.includes("mist")) {
            weatherImage.src = "WeatherApplication//assets/5729389_cloud_foggy_weather_cloudy_forecast_icon.png";
        } else {
            weatherImage.src = "WeatherApplication/assets/2682802_cloudy_day_fog_foggy_mist_icon.png"";
        }
